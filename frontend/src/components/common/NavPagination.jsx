        ...
        <ul className="inline-flex items-stretch -space-x-px">
          ...
          <li>
            <Link to=""
              ...
              aria-current="page"
              className="flex items-center justify-center text-sm z-10 py-2 px-3 leading-tight text-primary bg-primary/30 border border-primary hover:bg-primary/50 hover:text-primary dark:border-gray-700 dark:bg-gray-700 dark:text-white"
            >
              3
            </Link>
          </li>
