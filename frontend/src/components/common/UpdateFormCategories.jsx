...
const UpdateFormCategories = ({ closeForm, category }) => {
  const [selectedImage, setSelectedImage] = useState({imageUrl: category.imgProfileUrl});
  ...
  const handleSubmit = async (event) => {
    ...
    setIsLoading(true);
    try {
      updatedCategory = await updateCategory(category.id ,{name: categoryName, description: description});
      setIsLoading(false);
      closeForm();
...
UpdateFormCategories.propTypes = {
  closeForm: PropTypes.func.isRequired,
  category: PropTypes.object,
};

export default UpdateFormCategories;
