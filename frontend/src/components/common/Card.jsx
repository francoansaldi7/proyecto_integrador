  ...
  <div className="h-[200px] overflow-hidden">
    ...
    <div className="px-5 py-5">
        ...
        <div className="flex flex-row mb-2">
          ...
          <Link to="/details" state={{img, title, description, price}}><p className=" text-primary pointer hover:underline hover:text-secondary mt-4">... mas</p></Link>
        </div>
            
        <div className="flex items-center justify-between gap-[4px]">
            <span className="text-3xl font-bold text-gray-900 dark:text-white">${price}/<span className="text-gray-400 text-xs font-semibold">por hora</span></span>
