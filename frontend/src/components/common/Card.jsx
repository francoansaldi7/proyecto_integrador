...
<div className={` w-full relative max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 ${moreBig ? 'scale-125  translate-x-[-40px]' : ''} transition duration-500`}>
